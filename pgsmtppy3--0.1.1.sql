...
--Envio de Correo Simple a destinatario(s) 
...
if result:
    ...
    try:
        ...
        return "Unable to send the email. Error: ", sys.exc_info()
		
$BODY$
LANGUAGE plpython3u VOLATILE;


--Envio de correo simple a destinatarios y con copia a otros destinatarios
CREATE OR REPLACE FUNCTION pgsmtp.pg_smtp_mail(
    sender character varying,
    receiver character varying,
    cc text[],
...
--Envio de Correo simple a destinatarios, copias y ocultas 
...
--Envio de correo simple a destinatarios con copia oculta a otros destinatarios
CREATE OR REPLACE FUNCTION pgsmtp.pg_smtp_mail_hide(
    sender character varying,
    receiver character varying,
    cco text[],
    topic character varying,
...
--Envio de Correo Simple a destinatario(s) con archivos adjuntos
...
--Envio de Correo Simple a destinatarios con copias y archivos adjuntos
CREATE OR REPLACE FUNCTION pgsmtp.pg_smtp_mail_attach(
    sender character varying,
    receiver character varying,
    cc text[],
...
-- Envio de correo a destinatarios con copias, copias ocultas y archivos adjuntos
...
--Envio de Correo Simple con copias ocultas y archivos adjuntos
CREATE OR REPLACE FUNCTION pgsmtp.pg_smtp_mail_attach_hide(
    sender character varying,
    receiver character varying,
    cco text[],
    topic character varying,
